...
from nerfstudio.scripts.render_blocknerf import BlockNerfRenderTrajectory, RenderTrajectory
...
class ExperimentPipeline:
    ...
    def train(self):
        ...
        launch(
            ...
            num_devices_per_machine=self.trainer_config.machine.num_devices,
